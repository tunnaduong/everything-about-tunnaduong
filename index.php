  ...
  <div class="main">
    ...
    <div class="main--section-2">
      ...
      <div class="section--content">
        ...
        $sql = "SELECT * FROM wp_posts ORDER BY id DESC LIMIT 3";
  ...
  <center>
    <footer>
      <p class="footer--copyright">
        <span id="footer--mobile">© 2022 Duong Tung Anh<br /><span style="color: gray; font-weight: 300; font-size: 15px">All rights reserved</span></span>
