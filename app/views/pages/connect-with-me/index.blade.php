...
@section('title', 'Kết nối với mình')
...
@section('content')
    <center class="mt-10">
        ...
        <div class="flex flex-col items-center">
            <a href="tel:+84365520031" external id="btn-call" class="social-btn uppercase">
                <i class="fas fa-phone-alt"></i>
                Gọi điện cho mình
            </a>
            <a href="mailto:contact@tunnaduong.com" external id="btn-gmail" class="social-btn uppercase">
                <i class="fas fa-envelope"></i>
                Gửi mail cho mình
            </a>
            <a href="https://facebook.com/tunnaduong" newtab id="btn-facebook" class="social-btn uppercase">
            ...
            <a href="https://youtube.com/@tunnaduong" newtab id="btn-youtube" class="social-btn uppercase">
            ...
            <a href="https://github.com/tunnaduong" newtab id="btn-github" class="social-btn uppercase">
