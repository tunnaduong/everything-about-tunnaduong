...
@i f ($rel != 'page'
    ...
    aLayer.push(arguments);
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
         <link rel="
    icon" type="image/x-png" href="/static/img/tunnaduong.png" />
            <title>@yield('title', 'Tất cả mọi thứ về Tunna Duong')</title>
            <link rel="stylesheet" href="/static/css/style.css" />
           <script rc="/static/js/jquery.min.js"></script>
            <script src="/static/js/typed.min.js"></script>
            <script src="/static/js/moment.min.js"></script>
           <script rc="/static/js/nprogress.js"></script>
